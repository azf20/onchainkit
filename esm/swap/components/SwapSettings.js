...
function SwapSettings({
  ...
  return /*#__PURE__*/jsxs("div", {
    className: cn('flex w-auto items-center justify-end space-x-1', className),
    ...
    children: [buttonText && /*#__PURE__*/jsx("span", {
      ...
      children: [/*#__PURE__*/jsx("button", {
      ...
      }), breakpoint === 'sm' ? /*#__PURE__*/jsx(FocusTrap, {
        active: isOpen,
        children: /*#__PURE__*/jsx(DismissableLayer, {
          ...
          children: /*#__PURE__*/jsx("div", {
            className: cn(background.inverse, pressable.shadow, 'fixed inset-x-0 z-50 transition-[bottom] duration-300 ease-in-out', isOpen ? 'bottom-0' : '-bottom-[12.875rem]', 'h-[12.875rem] rounded-t-lg', className),
