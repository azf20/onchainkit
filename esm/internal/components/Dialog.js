...
function Dialog({
  ...
  const dialog = /*#__PURE__*/jsx("div", {
    className: cn(componentTheme, zIndex.modal, 'fixed inset-0 flex items-center justify-center', 'bg-black/50 transition-opacity duration-200', 'fade-in animate-in duration-200'),
  ...
  return /*#__PURE__*/createPortal(dialog, document.body);
}
export { Dialog };
