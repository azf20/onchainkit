 ...
 */
export declare function TokenChip({ token, onClick, className, isPressable, }: TokenChipReact): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=TokenChip.d.ts.map