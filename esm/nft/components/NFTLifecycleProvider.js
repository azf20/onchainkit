...
const emptyContext = {};
const NFTLifecycleContext = /*#__PURE__*/createContext(emptyContext);
...
function NFTLifecycleProvider({
  ...
  return /*#__PURE__*/jsx(NFTLifecycleContext.Provider, {
    value: value,
    children: children
  });
}
export { NFTLifecycleContext, NFTLifecycleProvider, useNFTLifecycleContext };
