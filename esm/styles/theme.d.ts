...
export declare const text: {
    readonly body: "ock-font-family font-normal text-base";
    readonly caption: "ock-font-family font-semibold text-xs";
    readonly headline: "ock-font-family font-semibold";
    readonly label1: "ock-font-family font-semibold text-sm";
    readonly label2: "ock-font-family text-sm";
    readonly legal: "ock-font-family text-xs";
    readonly title1: "ock-font-family font-semibold text-2xl";
    readonly title3: "ock-font-family font-semibold text-xl";
};
...
export declare const border: {
    ...
    readonly linePrimary: "ock-border-line-primary border";
    readonly lineDefault: "ock-border-line-default border";
    readonly lineHeavy: "ock-border-line-heavy border";
    readonly lineInverse: "ock-border-line-inverse border";
