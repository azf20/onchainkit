...
const usePaymentMethods = ({
  ...
  const handleFetchPaymentMethods = useCallback(async () => {
    ...
    try {
      ...
      const paymentMethods = buildPaymentMethods(paymentOptions, currency, country);
  ...
  }, [country, subdivision, currency, setPaymentMethods, setIsPaymentMethodsLoading, onError]);
