...
function WalletBottomSheet({
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [isSubComponentOpen && /*#__PURE__*/jsx("div", {
      ...
      className: cn(background.default, 'fixed right-0 bottom-0 left-0 z-50', 'transform rounded-[20px_20px_0_0] p-4 transition-transform', `${isSubComponentOpen ? 'translate-y-0' : 'translate-y-full'}`, className),
