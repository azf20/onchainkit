...
} & Pick<SendContextType, 'selectedToken' | 'cryptoAmount' | 'handleCryptoAmountChange' | 'fiatAmount' | 'handleFiatAmountChange' | 'selectedInputType' | 'setSelectedInputType' | 'exchangeRate' | 'exchangeRateLoading'>;
...
} & Pick<SendContextType, 'selectedToken' | 'handleTokenSelection' | 'handleResetTokenSelection' | 'setSelectedInputType' | 'handleCryptoAmountChange' | 'handleFiatAmountChange'>;
