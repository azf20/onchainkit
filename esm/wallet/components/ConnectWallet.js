...
function ConnectWallet({
  ...
  const _useWalletContext = useWalletContext(),
    setIsConnectModalOpen = _useWalletContext.setIsConnectModalOpen,
  ...
  const _useState3 = useState(false),
    ...
    setIsModalOpen = _useState4[1]; // duplicate modal state because ConnectWallet not always within WalletProvider
  ...
  return /*#__PURE__*/jsx(IdentityProvider, {
    ...
    children: /*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsx("button", {
        ...
        className: cn(pressable.secondary, border.radius, color.foreground, 'px-4 py-3', isSubComponentOpen && 'ock-bg-secondary-active hover:ock-bg-secondary-active', className),
