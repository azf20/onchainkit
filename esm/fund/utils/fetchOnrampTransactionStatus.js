...
async function fetchOnrampTransactionStatus({
  ...
  const response = await fetch(`${ONRAMP_API_BASE_URL}/buy/user/${partnerUserId}/transactions?page_key=${nextPageKey}&page_size=${pageSize}`, {
    method: 'GET',
    headers: {
...
export { fetchOnrampTransactionStatus };
